...
\
  ...
  set_property CONFIG.C_PROBE_OUT0_WIDTH {32} $vio_0
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila/SLOT_0_AXI]
  connect_bd_intf_net -intf_net system_ila_TRIG_OUT [get_bd_intf_pins zynq_ultra_ps_e_0/PL_PS_TRIGGER_0] [get_bd_intf_pins system_ila/TRIG_OUT]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_PS_PL_TRIGGER_0 [get_bd_intf_pins zynq_ultra_ps_e_0/PS_PL_TRIGGER_0] [get_bd_intf_pins system_ila/TRIG_IN]

  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins system_ila/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins vio_0/probe_out0] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins vio_0/clk] [get_bd_pins system_ila/clk]
...
generate_target all [get_files  ./zcu102/zcu102.srcs/sources_1/bd/design_1/design_1.bd]

make_wrapper -files [get_files ./zcu102/zcu102.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./zcu102/zcu102.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
...
if {$implement == 1} {
	launch_runs impl_1 -to_step write_bitstream
	write_hw_platform -include_bit -fixed -force -file ./zcu102/design_1_wrapper.xsa
	exit
} else {
