...
int main(int argc, const char** argv)
{
  ...
  parser.getOption("-w", width,       "Image width (default 1000)");
  parser.getOption("-h", height,      "Image height (default 30)");
  ...
  unsigned num_coefs_padded = ceil(num_coefs/64.0)*64; ;
  ...
  if(diff) {
      printf("Test FAILED: Output has mismatches with reference\n");    
  } else {
