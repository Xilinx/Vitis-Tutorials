...
4. Follow the instructions to install Petalinux Tools in [UG1144 PetaLinux Tools Documentation](https://www.xilinx.com/search/support-keyword-search.html#q=ug1144)
5. Download the `xilinx-vck190-es1-v2020.2-final.bsp` from TODO add link to download BSP
...
Edit the `env_setup_2020.sh` script with your file paths:
...
This module shows RTL designers how to:
  ...
  * Map beamforming functions to PL kernels with a base platform.
  * Design PL kernels with the beamforming source code as an example.
  * Use the V++ compiler (and understand why unique options are used for this design).

[Read more...](Module_03_PL_Design)

## Module 04 - AI Engine and PL Integration

This module shows developers how to combine an AI Engine graph (``libsdf.a``) and ``\*.xo`` PL kernels into an XCLBIN.

[Read more...](Module_04_AI_Engine_and_PL_Integration)

## Module 05 - Bare-Metal PS Host Application

This module shows software developers how to create a bare-metal application for beamforming, and showcases bare-metal emulation for PL debug.
...
This module shows developers how to build a PetaLinux software platform.
