...
set IP_NAME "ulbf_data"
set IP_REPO "build"
set project "project_ulbf_data"
create_project $project ./$project -part [lindex $argv 1] -force

add_files -norecurse ./hdl/ulbf_data.v
add_files -norecurse ./hdl/ulbf_data_master.v
add_files -norecurse ./hdl/ulbf_data_cntrl.v
add_files -norecurse ./hdl/ulbf_data_csr_cntrl.v
add_files -norecurse ./hdl/ulbf_data_cdc.v
add_files -norecurse ./hdl/ulbf_data_xpm_sync_fifo.v
add_files -norecurse ./hdl/ulbf_data_ram2axis_64b.v
add_files -norecurse ./hdl/ulbf_data_xpm_ram.v
add_files -norecurse ../data/ulbf_din0_hex.mem
add_files -norecurse ../data/ulbf_din1_hex.mem
add_files -norecurse ../data/ulbf_din2_hex.mem
add_files -norecurse ../data/ulbf_din3_hex.mem
add_files -norecurse ../data/ulbf_din4_hex.mem
add_files -norecurse ../data/ulbf_din5_hex.mem
add_files -norecurse ../data/ulbf_din6_hex.mem
add_files -norecurse ../data/ulbf_din7_hex.mem

create_bd_design "design_ulbf_data"
