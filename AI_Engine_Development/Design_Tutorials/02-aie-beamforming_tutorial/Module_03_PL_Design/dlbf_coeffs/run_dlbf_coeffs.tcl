...
set IP_NAME "dlbf_coeffs"
set IP_REPO "build"
set project "project_dlbf_coeffs"
create_project $project ./$project -part [lindex $argv 1] -force

add_files -norecurse ./hdl/dlbf_coeffs.v
add_files -norecurse ./hdl/dlbf_coeffs_master.v
add_files -norecurse ./hdl/dlbf_coeffs_cntrl.v
add_files -norecurse ./hdl/dlbf_coeffs_csr_cntrl.v
add_files -norecurse ./hdl/dlbf_coeffs_cdc.v
add_files -norecurse ./hdl/dlbf_coeffs_xpm_sync_fifo.v
add_files -norecurse ./hdl/dlbf_coeffs_ram2axis_64b.v
add_files -norecurse ./hdl/dlbf_coeffs_xpm_ram.v
add_files -norecurse ../data/dlbf_cin00_hex.mem
add_files -norecurse ../data/dlbf_cin01_hex.mem
add_files -norecurse ../data/dlbf_cin02_hex.mem
add_files -norecurse ../data/dlbf_cin03_hex.mem

create_bd_design "design_dlbf_coeffs"
