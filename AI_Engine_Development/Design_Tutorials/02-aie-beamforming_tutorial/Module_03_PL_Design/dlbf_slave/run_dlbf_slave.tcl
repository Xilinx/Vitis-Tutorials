...
set IP_NAME "dlbf_slave"
set IP_REPO "build"
set project "project_dlbf_slave"
create_project $project ./$project -part [lindex $argv 1] -force

add_files -norecurse ./hdl/dlbf_slave_ram.v
add_files -norecurse ./hdl/dlbf_slave_cntrl.v
add_files -norecurse ./hdl/dlbf_slave_cdc.v
add_files -norecurse ./hdl/dlbf_slave.v

create_bd_design "design_dlbf_slave"
#set argv [lindex $argv 1]
#set argc 1
source ./bd_dlbf_slave.tcl

make_wrapper -files [get_files ./$project/$project.srcs/sources_1/bd/design_dlbf_slave/design_dlbf_slave.bd] -top
add_files -norecurse ./$project/$project.srcs/sources_1/bd/design_dlbf_slave/hdl/design_dlbf_slave_wrapper.v

import_files

set_property top dlbf_slave [current_fileset]
...
unset bypass
ipx::package_project -root_dir [pwd]/../${IP_REPO}/dlbf_slave -vendor xilinx.com -library user -taxonomy /UserIP -import_files -set_current false -force
ipx::unload_core [pwd]/../${IP_REPO}/dlbf_slave/component.xml
ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory ../${IP_REPO}/dlbf_slave [pwd]/../${IP_REPO}/dlbf_slave/component.xml
update_compile_order -fileset sources_1
...
set_property  ip_repo_paths  [pwd]/../${IP_REPO}/dlbf_slave [current_project]
update_ip_catalog

#package_xo -kernel_name dlbf_slave -kernel_xml ./kernel_dlbf_slave.xml -ip_directory [pwd]/../${IP_REPO}/dlbf_slave -xo_path [pwd]/../${IP_REPO}/dlbf_slave/dlbf_slave.xo -force
#package_xo -kernel_name dlbf_slave -ctrl_protocol user_managed -ip_directory [pwd]/../${IP_REPO}/dlbf_slave -xo_path [pwd]/../${IP_REPO}/dlbf_slave/dlbf_slave.xo -force -output_kernel_xml [pwd]/kernel_dlbf_slave_auto.xml
