...
#package_xo -kernel_name ulbf_slave -kernel_xml ./kernel_ulbf_slave.xml -ip_directory [pwd]/../${IP_REPO}/ulbf_slave -xo_path [pwd]/../${IP_REPO}/ulbf_slave/ulbf_slave.xo -force
#package_xo -kernel_name ulbf_slave -ctrl_protocol user_managed -ip_directory [pwd]/../${IP_REPO}/ulbf_slave -xo_path [pwd]/../${IP_REPO}/ulbf_slave/ulbf_slave.xo -force -output_kernel_xml [pwd]/kernel_ulbf_slave_auto.xml
