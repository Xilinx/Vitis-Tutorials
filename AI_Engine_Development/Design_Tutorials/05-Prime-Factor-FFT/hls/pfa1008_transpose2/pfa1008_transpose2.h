...
namespace pfa1008_transpose2 {
  static constexpr unsigned      SSR_IO = 2;
  static constexpr unsigned        NFFT = 7 * 9 * 16;
...
void pfa1008_transpose2_wrapper( pfa1008_transpose2::TT_STREAM sig_i[pfa1008_transpose2::SSR_IO],
                                 pfa1008_transpose2::TT_STREAM sig_o[pfa1008_transpose2::SSR_IO] );
