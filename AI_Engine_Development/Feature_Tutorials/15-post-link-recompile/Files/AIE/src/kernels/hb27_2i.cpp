...
void fir_27t_sym_hb_2i
(
	input_buffer<cint16,adf::extents<adf::inherited_extent>,adf::margin<INTERPOLATOR27_INPUT_MARGIN>>  & __restrict cb_input,
	output_buffer<cint16> & __restrict cb_output)
	{
		...
		chess_loop_range(8,)
		{
			...
			*OutIter++ = acc0.to_vector_zip<cint16>(sft);
			*OutIter++ = acc1.to_vector_zip<cint16>(sft);
