...
6. On the platform page, select the platform you want to use:
      ...
      * If you have created the platform following step 1, select the **base_pfm_vek385** platform you just created. If you do not use the same workspace from last step, click **Add**, and select the folder `base_pfm_vek385/export` to add the platform into this workspace.
      * If you have skipped step 1, select the VEK385 base platform (xilinx_vek385_base_202510_1) which is part of the Vitis installation.
      ...
      ![missing image](images/251_aie_app_pg2_vek385.jpg)
