...
*Target Device: AMD Versal xc2ve3858-ssva2112-2MP-e-S*

| Resource | Used | Available | Utilization (%) |
|----------|------|-----------|-----------------|
| **FF** | 9,995 | 1,086,208 | <1% |
| **LUT** | 13,061 | 543,104 | 2% |
| **BRAM_18K** | 0 | 2,684 | 0% |
| **URAM** | 0 | 118 | 0% |
| **DSP** | 0 | 2,064 | 0% |
...
- AMD Versal Adaptive SoC AIE-ML v2 Architecture Manual: https://docs.amd.com/r/en-US/am027-versal-aie-ml-v2
