...
class transpose0_graph : public graph {
public:
  ...
  // Constructor:
  transpose0_graph( void )
  {
    // Write samples in linear transform order (3D cube)
    // --> incoming data from DFT-7 transforms in 1st dimension
    ...
    // --> outgoing data for DFT-9 transforms in 2nd dimension
