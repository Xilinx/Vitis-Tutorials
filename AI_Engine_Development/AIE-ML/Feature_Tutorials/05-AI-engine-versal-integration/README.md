...
4. Set up your PLATFORM_REPO_PATHS environment variable to ```$XILINX_VITIS/base_platforms/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm```.
...
```bash
v++ -c --mode aie --target hw --platform $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm --include "$XILINX_VITIS/aietools/include" --include "./aie" --include "./data" --include "./aie/kernels" --include "./" --aie.xlopt=0 --work_dir=./Work aie/graph.cpp
```
...
```bash
v++ -c --mode hls --platform $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm --config pl_kernels/s2mm.cfg
v++ -c --mode hls --platform $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm --config pl_kernels/mm2s.cfg
```
...
```bash
v++ -l --platform $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm s2mm.xo mm2s.xo libadf.a -t hw_emu --save-temps -g --config system.cfg -o tutorial.xsa
```
...
cd ./sw
v++ --package -t hw_emu \
    -f $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm \
...
1. To build for hardware, run the following command:
    ...
    ```bash
    v++ -l --platform $PLATFORM_REPO_PATHS/xilinx_vek280_base_202610_1/xilinx_vek280_base_202610_1.xpfm s2mm.xo mm2s.xo libadf.a -t hw --save-temps -g --config system.cfg -o tutorial.xsa
   ```
...
* How to link the `libadf.a`, PLIO, and PL kernels to the `xilinx_vek280_base_202610_1` platform
