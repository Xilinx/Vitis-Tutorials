...
public:
  ...
  static constexpr unsigned             TP_CASC_LEN = 4;
  static constexpr unsigned                  TP_SAT = 1;
  static constexpr unsigned                  TP_SSR = 2;
  ...
  gemm_16x32x8_graph( void )
  {
    ...
    adf::location<adf::graph>(*this) = adf::area_group({{adf::aie_tile, 18, 0, 21, 1},{adf::shim_tile,18,0,21,0}});
  }
};
