...
>**IMPORTANT**: Before beginning the tutorial, read the *Vitis Software Platform Release Notes* (v2026.1) to set up the software and install the VCK190 base platform.
