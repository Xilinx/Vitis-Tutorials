...
2. In a Bash shell, run `/Common Images Dir/xilinx-versal-common-v2025.1/environment-setup-cortexa72-cortexa53-amd-linux script`. This script sets up the `SDKTARGETSYSROOT` and `CXX` variables. If the script is not present, you must run `/Common Images Dir/xilinx-versal-common-v2025.1/sdk.sh`.
...
This tutorial targets a 2025.1 VCK190 production board.
