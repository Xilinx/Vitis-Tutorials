...
if {$RTL_out_bd == "1"} {
	...
	export_simulation -of_objects [get_files ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.srcs/sources_1/ip/AXI4S_Counter_0/AXI4S_Counter_0.xci] -directory ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files/sim_scripts -ip_user_files_dir ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files -ipstatic_source_dir ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files/ipstatic -lib_map_path [list {modelsim=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/modelsim} {questa=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/questa} {xcelium=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/xcelium} {vcs=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/vcs} {riviera=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
	...
	export_simulation -of_objects [get_files ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.srcs/sources_1/ip/dummy_sink_0/dummy_sink_0.xci] -directory ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files/sim_scripts -ip_user_files_dir ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files -ipstatic_source_dir ./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.ip_user_files/ipstatic -lib_map_path [list {modelsim=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/modelsim} {questa=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/questa} {xcelium=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/xcelium} {vcs=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/vcs} {riviera=./build/custom_pfm_strmIn_strmOut_RTL_out/custom_pfm_strmIn_strmOut_RTL_out.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
}
