...
class clipped : public graph {  
  ...
  public:
    ...
    clipped() {
      ...
      in = adf::input_plio::create("in_interpolator", adf::plio_32_bits);
      clip_out = adf::input_plio::create("in_classifier", adf::plio_32_bits);
      
      //Output PLIO object that sends output data
      out = adf::output_plio::create("out_classifier",adf::plio_32_bits);
      ...
      in = adf::input_plio::create("in_interpolator", adf::plio_32_bits,"data/interpolator_in.txt");
      clip_out = adf::input_plio::create("in_classifier", adf::plio_32_bits,"data/classifier_in.txt");

      
      //Output PLIO object that specifies the file containing output data
      out = adf::output_plio::create("out_classifier",adf::plio_32_bits, "data/classifier_out.txt");
      clip_in = adf::output_plio::create("out_interpolator",adf::plio_32_bits, "data/interpolator_out.txt");
#endif
