...
public:
  ...
  alignas(32) TT_SIG y3[BUFFER_SIZE];
  alignas(32) TT_SIG y2[BUFFER_SIZE];
  alignas(32) TT_SIG y1[BUFFER_SIZE];
  alignas(32) TT_SIG y0[BUFFER_SIZE];
  alignas(32) TT_SIG z2[BUFFER_SIZE];
  alignas(32) TT_SIG z1[BUFFER_SIZE];
