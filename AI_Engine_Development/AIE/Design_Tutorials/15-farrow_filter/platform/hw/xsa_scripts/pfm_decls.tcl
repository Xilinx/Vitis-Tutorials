...
# Create PFM attributes
  ...
  set_property PFM.CLOCK {clk_out1 {id "1" is_default "false" proc_sys_reset "psr_104mhz" status "fixed" freq_hz "104166666"} clk_out2 {id "4" is_default "false" proc_sys_reset "/psr_208mhz" status "fixed" freq_hz "208333333"} clk_out3 {id "5" is_default "false" proc_sys_reset "/psr_416mhz" status "fixed" freq_hz "416666666"} clk_out4_o1 {id "6" is_default "false" proc_sys_reset "/psr_625mhz" status "fixed" freq_hz "625000000"} clk_out4_o2 {id "2" is_default "true" proc_sys_reset "/psr_312mhz" status "fixed" freq_hz "312500000"} clk_out4_o3 {id "0" is_default "false" proc_sys_reset "/psr_156mhz" status "fixed" freq_hz "156250000"} clk_out4_o4 {id "3" is_default "false" proc_sys_reset "/psr_78mhz" status "fixed" freq_hz "78125000"}} [get_bd_cells /clk_wizard_0]
