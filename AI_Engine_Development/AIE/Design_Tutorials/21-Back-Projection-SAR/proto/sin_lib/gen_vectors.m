...
vfs_model = vfs.aieGraph(input_file="sin_lib_app.cpp",...
...
figure;
subplot(3,1,1); plot(data_i,'b.-'); title('sin() Input');
subplot(3,1,2); plot(data_o,'b.-'); hold on; plot(vfs_o,'r.'); hold off; title('sin() Output');
subplot(3,1,3); plot(err_o,'k.-'); ylabel('error'); title('sin() Error'); 
