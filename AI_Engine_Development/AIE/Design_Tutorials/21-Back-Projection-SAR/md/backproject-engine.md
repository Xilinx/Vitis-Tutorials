...
* You need the read and write sides to stall independently as they can stall at different times. This is achieved by each side validating the state of the AXI-S streams before performing a read or a write operation. The aspects of the code involved in these checks are annotated in red in the following figure. 
