...
* The design illustrates how to use PL URAM storage tightly coupled in a high performance feedback loop with the AI Engine array. HLS coding techniques illustrate how to handle AXI-S stream back-pressure to isolate the read and write portions of the design.  
