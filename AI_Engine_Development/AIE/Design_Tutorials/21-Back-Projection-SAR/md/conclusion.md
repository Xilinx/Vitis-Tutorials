...
The tutorial showed some important concepts and new features in the Versal AI Engine tool flows and methodology:
...
* The design shows how to use PL URAM storage coupled in a high performance feedback loop with the AI Engine array. HLS coding techniques show how to handle AXI-S stream back-pressure to isolate the read and write portions of the design.
