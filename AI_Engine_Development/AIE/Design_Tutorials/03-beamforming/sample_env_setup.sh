...
export XILINX_VITIS=<PATH-TO-VITIS-BUILD-DIRECTORY>/Vitis/2025.1
export COMMON_IMAGE_VERSAL=<PATH TO xilinx-versal-common-v2025.1 - DIRECTORY>
...
#To source petalinux: 
source <PATH TO petalinux-v2025.1-final>/settings.sh
