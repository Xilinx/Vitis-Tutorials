...
export XILINX_VITIS=<PATH-TO-VITIS-BUILD-DIRECTORY>/Vitis/2025.2
export COMMON_IMAGE_VERSAL=<PATH TO xilinx-versal-common-v2025.2 - DIRECTORY>
export BSP_DIR=<PATH TO xilinx-petalinux-DIRECTORY>/bsp/release
export BSP=xilinx-vck190-v2025.2-final.bsp
...
#To source petalinux: 
source <PATH TO petalinux-v2025.2-final>/settings.sh
