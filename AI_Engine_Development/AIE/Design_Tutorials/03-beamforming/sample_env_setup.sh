...
export XILINX_VITIS=<PATH-TO-VITIS-BUILD-DIRECTORY>/Vitis/2024.1
export COMMON_IMAGE_VERSAL=<PATH TO xilinx-versal-common-v2024.1 - DIRECTORY>
export BSP_DIR=<PATH TO xilinx-petalinux-DIRECTORY>/bsp/release
export BSP=xilinx-vck190-v2024.1-final.bsp
...
#To source petalinux: 
source <PATH TO petalinux-v2024.1-final>/settings.sh
