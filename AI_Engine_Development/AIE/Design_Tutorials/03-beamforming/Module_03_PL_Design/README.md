...
### References
* [Vitis Application Acceleration Development Flow Documentation, Developing Applications, RTL Kernels](https://docs.amd.com/r/en-US/ug1702-vitis-accelerated-reference/) - This is a reference on how to create your own custom RTL kernels. Please note that the PL kernels in this design do not completely and here to the recommended guidelines.
