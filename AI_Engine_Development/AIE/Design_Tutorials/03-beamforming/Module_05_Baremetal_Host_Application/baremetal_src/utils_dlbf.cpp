...
XPAR_VITISREGION_DLBF_DATA_00_BASEADDR,
XPAR_VITISREGION_DLBF_DATA_10_BASEADDR,
XPAR_VITISREGION_DLBF_DATA_20_BASEADDR,
};

uint64_t dlbfCoeffsAddr[NUM_DLBF_COEFFS] = {
XPAR_VITISREGION_DLBF_COEFFS_00_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_01_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_02_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_03_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_04_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_05_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_06_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_07_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_10_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_11_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_12_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_13_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_14_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_15_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_16_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_17_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_20_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_21_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_22_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_23_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_24_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_25_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_26_BASEADDR,
XPAR_VITISREGION_DLBF_COEFFS_27_BASEADDR,
};

uint64_t dlbfSlaveAddr[NUM_DLBF_SLAVES] = {
XPAR_VITISREGION_DLBF_O00_BASEADDR,
XPAR_VITISREGION_DLBF_O01_BASEADDR,
XPAR_VITISREGION_DLBF_O02_BASEADDR,
XPAR_VITISREGION_DLBF_O03_BASEADDR,
XPAR_VITISREGION_DLBF_O04_BASEADDR,
XPAR_VITISREGION_DLBF_O05_BASEADDR,
XPAR_VITISREGION_DLBF_O06_BASEADDR,
XPAR_VITISREGION_DLBF_O07_BASEADDR,
XPAR_VITISREGION_DLBF_O10_BASEADDR,
XPAR_VITISREGION_DLBF_O11_BASEADDR,
XPAR_VITISREGION_DLBF_O12_BASEADDR,
XPAR_VITISREGION_DLBF_O13_BASEADDR,
XPAR_VITISREGION_DLBF_O14_BASEADDR,
XPAR_VITISREGION_DLBF_O15_BASEADDR,
XPAR_VITISREGION_DLBF_O16_BASEADDR,
XPAR_VITISREGION_DLBF_O17_BASEADDR,
XPAR_VITISREGION_DLBF_O20_BASEADDR,
XPAR_VITISREGION_DLBF_O21_BASEADDR,
XPAR_VITISREGION_DLBF_O22_BASEADDR,
XPAR_VITISREGION_DLBF_O23_BASEADDR,
XPAR_VITISREGION_DLBF_O24_BASEADDR,
XPAR_VITISREGION_DLBF_O25_BASEADDR,
XPAR_VITISREGION_DLBF_O26_BASEADDR,
XPAR_VITISREGION_DLBF_O27_BASEADDR,
};
...
void dlbf_data_get_ip_status(unsigned int i, uint64_t ipBaseAddr) {
	...
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ID)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ROLLOVER    : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_data-0/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RAM_STATUS));  

	addr = ipBaseAddr + DLBF_DATA_RAM1_OFFSET + DLBF_DATA_CSR_OFFSET; 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ID)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ROLLOVER    : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_data-1/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RAM_STATUS));  

	addr = ipBaseAddr + DLBF_DATA_RAM2_OFFSET + DLBF_DATA_CSR_OFFSET; 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ID)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ROLLOVER    : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_data-2/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RAM_STATUS));  

	addr = ipBaseAddr + DLBF_DATA_RAM3_OFFSET + DLBF_DATA_CSR_OFFSET; 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ID)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_ROLLOVER    : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_data-3/3] IP:%d/%d DLBF_DATA_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_DATA-1, Xil_In32(addr+DLBF_DATA_REG_OFFSET_RAM_STATUS));  
...
void dlbf_coeffs_get_ip_status(unsigned int i, uint64_t ipBaseAddr) {
	...
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ID)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ROLLOVER	  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_coeffs-0/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RAM_STATUS));  

	addr = ipBaseAddr + DLBF_COEFFS_RAM1_OFFSET + DLBF_COEFFS_CSR_OFFSET; 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ID)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ROLLOVER	  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_coeffs-1/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RAM_STATUS));  

	addr = ipBaseAddr + DLBF_COEFFS_RAM2_OFFSET + DLBF_COEFFS_CSR_OFFSET; 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ID)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ROLLOVER	  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_coeffs-2/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RAM_STATUS));  
		
	addr = ipBaseAddr + DLBF_COEFFS_RAM3_OFFSET + DLBF_COEFFS_CSR_OFFSET; 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ID)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_BLOCK_SIZE)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_ROLLOVER	  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_ROLLOVER)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_coeffs-3/3] IP:%d/%d DLBF_COEFFS_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_COEFFS-1, Xil_In32(addr+DLBF_COEFFS_REG_OFFSET_RAM_STATUS));  
...
void dlbf_slave_config_ip(unsigned int i, uint64_t ipBaseAddr, unsigned int niter ) {
	uint64_t csrAddr = ipBaseAddr + DLBF_SLAVE_CSR_OFFSET ; 
...
void dlbf_slave_get_ip_status(unsigned int i, uint64_t ipBaseAddr) {
	...
	xil_printf("[dlbf_slave] IP:%d/%d DLBF_SLAVE_REG_OFFSET_ID          : 0x%10lX\n", i, NUM_DLBF_SLAVES-1, Xil_In32(addr+DLBF_SLAVE_REG_OFFSET_ID)); 
	xil_printf("[dlbf_slave] IP:%d/%d DLBF_SLAVE_REG_OFFSET_RESET       : 0x%10lX\n", i, NUM_DLBF_SLAVES-1, Xil_In32(addr+DLBF_SLAVE_REG_OFFSET_RESET)); 
	xil_printf("[dlbf_slave] IP:%d/%d DLBF_SLAVE_REG_OFFSET_NITER       : 0x%10lX\n", i, NUM_DLBF_SLAVES-1, Xil_In32(addr+DLBF_SLAVE_REG_OFFSET_NITER)); 
	xil_printf("[dlbf_slave] IP:%d/%d DLBF_SLAVE_REG_OFFSET_DONE        : 0x%10lX\n", i, NUM_DLBF_SLAVES-1, Xil_In32(addr+DLBF_SLAVE_REG_OFFSET_DONE)); 
	xil_printf("[dlbf_slave] IP:%d/%d DLBF_SLAVE_REG_OFFSET_RAM_STATUS  : 0x%10lX\n", i, NUM_DLBF_SLAVES-1, Xil_In32(addr+DLBF_SLAVE_REG_OFFSET_RAM_STATUS));  
}
...
void dlbf_data_check_ram(int ipNum, int * arrPtr0, int * arrPtr1, int * arrPtr2, int * arrPtr3) {
    ...
    for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM0_OFFSET + (i*8);
		uint64_t addr1   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM0_OFFSET + ((i*8)+4);
		...
		arrPtr0 = arrPtr0+4;
		xil_printf("[dlbf_data_check_ram] IP:%d/%d RAM0 DATA %d: 0x%10lX%08lX %d %d %d %d \n",ipNum, NUM_DLBF_DATA-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM1_OFFSET + (i*8);
		uint64_t addr1   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM1_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		arrPtr1 = arrPtr1+4;
		xil_printf("[dlbf_data_check_ram] IP:%d/%d RAM1 DATA %d: 0x%10lX%08lX %d %d %d %d \nn",ipNum, NUM_DLBF_DATA-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM2_OFFSET + (i*8);
		uint64_t addr1   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM2_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		arrPtr2 = arrPtr2+4;
		xil_printf("[dlbf_data_check_ram] IP:%d/%d RAM2 DATA %d: 0x%10lX%08lX %d %d %d %d \nn",ipNum, NUM_DLBF_DATA-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM3_OFFSET + (i*8);
		uint64_t addr1   = dlbfDataAddr[ipNum] + DLBF_DATA_RAM3_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		arrPtr3 = arrPtr3+4;
		xil_printf("[dlbf_data_check_ram] IP:%d/%d RAM3 DATA %d: 0x%10lX%08lX %d %d %d %d \nn",ipNum, NUM_DLBF_DATA-1, i, data1, data0, real0, imag0, real1, imag1);
	}
...
void dlbf_coeffs_check_ram(int ipNum, int * arrPtr0, int * arrPtr1, int * arrPtr2, int * arrPtr3) {
	...
	int errCount = 0;
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM0_OFFSET + (i*8);
		uint64_t addr1   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM0_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		if (imag1!=*(arrPtr0+3))  errCount++;
		arrPtr0 = arrPtr0+4;
		xil_printf("[dlbf_coeffs_check_ram] IP:%d/%d RAM0 DATA %d: 0x%10lX%08lX %d %d %d %d \n",ipNum, NUM_DLBF_COEFFS-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM1_OFFSET + (i*8);
		uint64_t addr1   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM1_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		if (imag1!=*(arrPtr1+3))  errCount++;
		arrPtr1 = arrPtr1+4;
		xil_printf("[dlbf_coeffs_check_ram] IP:%d/%d RAM1 DATA %d: 0x%10lX%08lX %d %d %d %d \n",ipNum, NUM_DLBF_COEFFS-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM2_OFFSET + (i*8);
		uint64_t addr1   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM2_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		if (imag1!=*(arrPtr2+3))  errCount++;
		arrPtr2 = arrPtr2+4;
		xil_printf("[dlbf_coeffs_check_ram] IP:%d/%d RAM2 DATA %d: 0x%10lX%08lX %d %d %d %d \n",ipNum, NUM_DLBF_COEFFS-1, i, data1, data0, real0, imag0, real1, imag1);
	}
	for (unsigned int i=0; i<5; i++ ) {
		uint64_t addr0   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM3_OFFSET + (i*8);
		uint64_t addr1   = dlbfCoeffsAddr[ipNum] + DLBF_COEFFS_RAM3_OFFSET + ((i*8)+4);
		unsigned int data0 = Xil_In32(addr0);
		unsigned int data1 = Xil_In32(addr1);
		int real0 = extractIQ(data0, 0); // 0 for lower 16b and 1 for upper 16b
		int imag0 = extractIQ(data0, 1);
		...
		if (imag1!=*(arrPtr3+3))  errCount++;
		arrPtr3 = arrPtr3+4;
		xil_printf("[dlbf_coeffs_check_ram] IP:%d/%d RAM3 DATA %d: 0x%10lX%08lX %d %d %d %d \n",ipNum, NUM_DLBF_COEFFS-1, i, data1, data0, real0, imag0, real1, imag1);
	}
