...
proc include_board {dts} {
  foreach lib [glob -nocomplain -directory device-tree-xlnx/device_tree/data/kernel_dtsi/2024.2/include/dt-bindings -type d *] {
    if {![file exists $dts/include/dt-bindings/[file tail $lib]]} {
      file copy -force $lib $dts/include/dt-bindings
    }
  }
  set dtsi_files [glob -nocomplain -directory device-tree-xlnx/device_tree/data/kernel_dtsi/2024.2/versal -type f *versal*]
