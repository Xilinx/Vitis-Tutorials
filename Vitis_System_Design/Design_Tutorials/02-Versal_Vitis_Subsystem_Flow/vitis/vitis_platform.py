...
dtsi_dir = curr_dir+"/../linux/src/"+board_name+"/recipes-bsp/device-tree/files/system-user.dtsi"
...
status = xrt_domain.set_bif(path=curr_dir+"/../linux/src/"+board_name+"/boot_custom.bif")
