...
set design_name vck190seg_thin
...
{PMC_MIO 26 .. 36}}} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M04_INI {read_bw {128} write_bw {128} initial_boot {true}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_INI {read_bw {128} write_bw {128} initial_boot {true}}} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M01_INI {read_bw {128} write_bw {128} initial_boot {true}} M05_INI {read_bw {128} write_bw {128} initial_boot {true}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M00_AXI:0x0} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_cci} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M02_INI {read_bw {128} write_bw {128} initial_boot {true}} M06_INI {read_bw {128} write_bw {128} initial_boot {true}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M00_AXI:0x0} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_cci} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M07_INI {read_bw {128} write_bw {128} initial_boot {true}} M03_INI {read_bw {128} write_bw {128} initial_boot {true}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M00_AXI:0x0} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_cci} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M00_INI {read_bw {5} write_bw {5} initial_boot {true}}} \
   CONFIG.DEST_IDS {} \
   CONFIG.NOC_PARAMS {} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M04_INI {read_bw {5} write_bw {5} initial_boot {true}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_INI {read_bw {5} write_bw {5} initial_boot {true}}} \
   CONFIG.DEST_IDS {M00_AXI:0x0} \
   CONFIG.NOC_PARAMS {} \
