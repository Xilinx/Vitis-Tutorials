...
proc create_root_design { parentCell } {
  ...
  set_property PFM.CLOCK {pl_clk0 {id "0" is_default "true" proc_sys_reset "/proc_sys_reset_0" status "fixed"} pl_clk1 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_1" status "fixed"}} [get_bd_cells /zynq_ultra_ps_e_0]
