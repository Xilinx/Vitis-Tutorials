...
##################################################################
# Evaluation of FCN8 CNN directly from DPU
#################################################################
...
CONV_INPUT_NODE = "block1_conv1_convolution"
CONV_OUTPUT_NODE= "conv2d_transpose_1_conv2d_transpose"
...
def main():
    ...
    x_test, y_test, img_file, seg_file = dpu_get_data(IMG_TEST_DIR, SEG_TEST_DIR,
