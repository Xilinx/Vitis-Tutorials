...
![Inference result](/Machine_Learning/Section_3-Basic/Module_5/res_output.jpg)
...
For baseline model, json file contents should be as below
```
{
  "target": "DPUv2",
  "lib": "libvart-dpu-runner.so",
...
Hope you enjoy it and let's move to [next module](/Machine_Learning/Section_3-Basic/Module_6/README.md) .
