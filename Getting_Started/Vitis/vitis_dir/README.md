...
3. xilinx_vck190_base_202420_1.xpfm: AMD provided platform

> **Important Note:** This tutorial uses the AMD provided platform. For custom platform flow details, please use the below link:
https://github.com/Xilinx/Vitis-Tutorials/tree/2024.2/Vitis_Platform_Creation
...
With the input files ready, we need to create a configuration file to provide guidance to the packager, let's call this file as pack.cfg.
...
rootfs=<path_platform>/xilinx-versal-common-v2024.2/rootfs.ext4
image_format=ext4
kernel_image=<path_platform>/xilinx-versal-common-v2024.2/Image
sd_file=host.exe
```
