...
* If you look into the directory where you ran your application, you will notice that a few files were generated by the run:
...
*NOTE: If you targeted the ZCU102 hardware, these files are stored on the SD card and you need to copy them back to your workstation to continue this lab. If you are running an Emulation build the files are stored in the QEMU environment and will need to be copied out of the emulation environment using an scp command.*
