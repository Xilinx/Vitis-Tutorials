...
3. `xilinx_vck190_base_202610_1.xpfm`: AMD provided platform

> **Important Note:** This tutorial uses the AMD provided platform. For custom platform flow details, please check tutorials under [Vitis_Platform_Creation](https://github.com/Xilinx/Vitis-Tutorials/tree/2026.1/Vitis_Platform_Creation)
...
v++ --link --target hw/hw_emu \
			--platform  xilinx_vck190_base_202610_1.xpfm \
			--config ./system.cfg \
			s2mm.xo mm2s.xo \
			libadf.a \
```
...
rootfs=<path_platform>/xilinx-versal-common-v2026.1/rootfs.ext4
image_format=ext4
kernel_image=<path_platform>/xilinx-versal-common-v2026.1/Image
sd_file=host.exe
```
