...
3. Setup Linux domain settings in Platform Settings view.
   ...
   - Set **Bif file**: Click the drop down button like below picture (highlight part) and select **Generate BIF**. The generated BIF file is generated in resource directory.
