...
##  Create the Software Components with PetaLinux

In this step, we will create Petalinux projects. We'll prepare two building methods. One is quick building for hardware test. The other is for system deep customization and create Vitis Platform required components. 



<details>
  <summary><b>Petalinux quick building approach</b></summary>
...
<details>
  <summary><b>Petalinux customization</b></summary>
