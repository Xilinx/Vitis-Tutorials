...
2. Download the base platform and place it under `workspace`  folder. Then extract it. If you have already installed the Vitis™ tool, omit this step as AMD Official platforms have already built into the vitis tool installation package.
   ...
   ```bash
   unzip xilinx_zcu104_base_202410_1.zip #extract the base platform
   cd xilinx_zcu104_base_202410_1
   tree -L 2
   .
   ├── hw
   │   └── hw.xsa
   ...
   │   └── xilinx_zcu104_base_202410_1.spfm
   ├── version
...
2. Create a PetaLinux project named **zcu104_petalinux** and configure the hw option with the XSA file:
   ...
   cd zcu104_petalinux
   petalinux-config --get-hw-description=xilinx_zcu104_base_202410_1/hw/hw.xsa  # After you extract the base platform, you can find hw.xsa or hw_emu.xsa under <xilinx_zcu104_base_202410_1> directory. If you want to do emulation you can choose hw_emu.xsa 
   ```
