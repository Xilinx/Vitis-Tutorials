...
class clipped : public graph {  
  ...
  public:
    ...
    clipped() {
      ...
      in = adf::input_plio::create("DataIn_"+std::to_string(N), adf::plio_32_bits,"data/input.txt");
      clip_out = adf::input_plio::create("clip_out_"+std::to_string(N), adf::plio_32_bits,"data/input2.txt");
      
      //Output PLIO object that specifies the file containing output data
      out = adf::output_plio::create("DataOut_"+std::to_string(N),adf::plio_32_bits, "data/output"+std::to_string(N)+".txt");
      clip_in = adf::output_plio::create("clip_in_"+std::to_string(N),adf::plio_32_bits, "data/output1"+std::to_string(N)+".txt");
