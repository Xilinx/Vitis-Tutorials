...
int main(int argc, char* argv[])
{
	...
	auto stream_out_khdl = xrt::kernel(device, xclbin_uuid, "stream_out");
	auto stream_out_rhdl = stream_out_khdl(in_bohdl, nullptr, sizeIn);
	printf("run stream_out\n");

	////////////////////////////////////////////////////////
	// stream_in ip - Creating kernel handle using xrt::kernel API
	///////////////////////////////////////////////////////		
	
	auto stream_in_khdl = xrt::kernel(device, xclbin_uuid, "stream_in");
	auto stream_in_rhdl = stream_in_khdl(out_bohdl, nullptr, sizeOut);
	printf("run stream_in\n");
