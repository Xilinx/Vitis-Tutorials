...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT_DRIVES {BUFG,BUFG,BUFG,MBUFGCE,BUFG,BUFG,BUFG} \
  ...
  connect_bd_net -net clk_wizard_0_clk_out4_o1_o1 [get_bd_pins clk_wizard_0/clk_out4_o1_o1] [get_bd_pins psr_625mhz/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out4_o1_o2 [get_bd_pins clk_wizard_0/clk_out4_o1_o2] [get_bd_pins psr_312mhz/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out4_o1_o3 [get_bd_pins clk_wizard_0/clk_out4_o1_o3] [get_bd_pins psr_156mhz/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out4_o1_o4 [get_bd_pins clk_wizard_0/clk_out4_o1_o4] [get_bd_pins psr_78mhz/slowest_sync_clk]
