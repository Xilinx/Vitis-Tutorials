...
* [**Section 3**](./Getting_Started/03-Algorithm_Acceleration) (a few hours):
  ...
  + [**Introduction**](./Getting_Started/03-Algorithm_Acceleration/docs/cpu_src)
    * Meet the Cholesky algorithm!
    * Run a CPU version
  + [**Vitis Module 1**](./Getting_Started/03-Algorithm_Acceleration/docs/module1_baseline)
  ...
  + [**Vitis Module 2**](./Getting_Started/03-Algorithm_Acceleration/docs/module2_pipeline) (short module to focus on the impact of <code>PIPELINE</code> and <code>INTERFACE</code>)
  ...
  + [**Vitis Module 3**](./Getting_Started/03-Algorithm_Acceleration/docs/module3_datatype)
  ...
  + [**Vitis Module 4**](./Getting_Started/03-Algorithm_Acceleration/docs/module4_dataflow)
