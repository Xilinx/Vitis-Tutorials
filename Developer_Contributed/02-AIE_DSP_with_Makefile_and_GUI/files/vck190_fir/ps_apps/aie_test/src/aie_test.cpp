...
int main(int argc, char* argv[]) {
  ...
  auto in_0 = xrt::kernel(my_device, xclbin_uuid, "mm2s_aie:{mm2s_aie_1}");
  std::cout << STR_PASSED << "auto in_0 = xrt::kernel(my_device, xclbin_uuid, \"mm2s_aie:{mm2s_aie_1}\")" << std::endl;

  auto in_0_bo = xrt::bo(my_device, bSizeIn, XCL_BO_FLAGS_NONE, in_0.group_id(0));
  std::cout << STR_PASSED << "auto in_0_bo = xrt::bo(my_device, bsize, XCL_BO_FLAGS_NONE, in_0.group_id(0) (=" << in_0.group_id(0) << "))" << std::endl;
  ...
  auto out_0 = xrt::kernel(my_device, xclbin_uuid, "s2mm_aie:{s2mm_aie_1}");
  std::cout << STR_PASSED << "auto out_0 = xrt::kernel(my_device, xclbin_uuid, \"s2mm_aie:{s2mm_aie_1}\")" << std::endl;
  ...
  my_graph.run(0);
  std::cout << STR_PASSED << "my_graph.run(0)" << std::endl;
