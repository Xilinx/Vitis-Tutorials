...
> **_In this module...:_** _Review the OpenCL API for the host/kernel paradigm<br>. Run Vitis via the GUI or make to execute software and hardware emulation. Run Vitis Analyzer to review the application timeline. Run Vitis HLS to identify the throughput bottleneck. Insert a testbench in HLS to iterate quickly on kernel code changes._
