...
The runs for this module with the kernel backannotated with the pragma should be same as in module1 as simple loops or inner loops are automatically pipelined.
