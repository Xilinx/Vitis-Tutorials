Code, files and instructions for **module 2** (same instructions as in [<b>module1</b>](../module1_baseline) to setup and run the Vitis tools)

This module is meant to focus on the pipeline pragma and go through the description below.
The runs for this module with the kernel backannotated with the pragma should be same as in **module1** since simple loops or inner loops are automatically pipelined.
