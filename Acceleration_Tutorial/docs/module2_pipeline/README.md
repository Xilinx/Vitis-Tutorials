...
The runs for this module with the kernel backannotated with the pragma should be same as in **module 1** since simple loops or inner loops are automatically pipelined.
