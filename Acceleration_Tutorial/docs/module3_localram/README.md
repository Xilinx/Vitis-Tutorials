...
The sp option (last line) in the <code>common.cfg</code> direct the <code>matrixA</code> pointer to attach to any of the 4 PLRAM segment available in the U50 card platform:
```
