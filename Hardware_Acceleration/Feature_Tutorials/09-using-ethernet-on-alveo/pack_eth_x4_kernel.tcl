...
add_files -norecurse \
       {                                         \
              ...
              ../ip_generation/xxv_ethernet_x4_0/xxv_ethernet_x4_0.xci \
       }
...
package_xo -force -xo_path ../ethernet_krnl_axis_x4.xo \
           -kernel_name ethernet_krnl_axis_x4 \
           -ctrl_protocol ap_ctrl_hs \
           -ip_directory ./eth_kernel_pack \
           -output_kernel_xml ../ethernet_krnl_axis_x4.xml
