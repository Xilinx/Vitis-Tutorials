...
For information on specific Vivado tool usage and optimization, refer to the *Vivado Design Suite User Guide: Implementation* ([UG904](https://www.xilinx.com/cgi-bin/docs/rdoc?v=latest;d=ug904-vivado-implementation.pdf)) and the *UltraFast Design Methodology Guide for FPGAs and SoCs* ([UG949](https://www.xilinx.com/cgi-bin/docs/rdoc?v=latest;d=ug949-vivado-design-methodology.pdf)).
...
5. This tutorial has provided host code to make it complete to run through various flows. The following commands are references to build the host and run the application.
   ...
   ./host apply_watermark.hw.xilinx_u250_gen3x16_xdma_4_1_202210_1.xclbin ../src/inputImage.bmp ../src/golden.bmp
   ```
