...
int main(int argc, char** argv) {
    ...
    //MH: Last parameter is memory bank. Specified the wrong bank will cause std::bad_alloc error
    //Run $xclbinutil --info --input binary_container_1.xclbin to check which memory bank was used
