...
>**IMPORTANT:**  
>
> * Before running any of the examples, make sure you have the Vitis core development kit as described in the *Vitis Development Environment Installation and Licensing*.
...
2. After the build has completed, run the host executable using the following command.
   ...
   This script is set up to run the application, and then spawn the integrated design environment (IDE). The IDE will automatically be populated with the collected run-time data.
   ...
   For details about the `xrt.ini` file, refer to the _Vitis Environment Reference Materials_.
...
For more information about tools and processes you can use to analyze the application performance in general, refer to the _Profiling, Optimizing, and Debugging the Application_.
